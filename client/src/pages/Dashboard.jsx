    ...
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex gap-4 '>
            ...
            <button onClick={()=> setShowUploadResume(true)} className='w-full bg-white sm:max-w-36n h-48e flex flex-col itemsa-center justify-center rounded-rlg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
